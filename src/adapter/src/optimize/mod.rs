...
pub struct OptimizerFlags {
    /// Eanble consolidation of unions that happen immediately after negate.
    ///
    /// The refinement happens in the LIR ⇒ LIR phase.
    pub enable_consolidate_after_union_negate: bool,
    /// Eanble relaxing of consolidation enforcers for optimization pipelines
...
impl From<&SystemVars> for OptimizerFlags {
...
/// by the optimizer implemenations.
