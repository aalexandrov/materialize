...
generate_extracted_config!(
    ...
    (HumanizedExprs, bool, Default(false)),
    (JoinImpls, bool, Default(false)),
...
impl TryFrom<ExplainPlanOptionExtracted> for ExplainConfig {
    ...
    fn try_from(mut v: ExplainPlanOptionExtracted) -> Result<Self, Self::Error> {
        ...
        Ok(ExplainConfig {
            ...
            humanized_exprs: !v.raw_plans && (v.humanized_exprs || enable_on_prod),
            join_impls: v.join_impls,
            keys: v.keys,
